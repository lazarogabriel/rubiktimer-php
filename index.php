...
<body>
    ...
    <div id="main" class="container-fluid h-100  flex-column align-items-center text-light">
        ...
        <div class="text-center mt-5">
            <?php if(isset($_SESSION['username'])): ?> 
                <a  href="servidor/scripts/session-destroy.php" class="text-warning">Log Out</a>
            <?php else: ?>
                <a href="#" id="btnShowLogIn" class="text-warning">Log In</a>
            <?php endif; ?>
    ...
    <div id="slide" class="d-flex flex-column text-dark">
        <div id="openStats" class="align-self-center text-center">
            <img src="public/img/angle-up-solid.svg" class="pt-1" width="25" >
            <h2>Tiempos</h2>
        </div>
